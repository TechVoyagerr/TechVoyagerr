...
[![LinkedIn](https://img.shields.io/badge/LinkedIn-AdarshKumar28-0A66C2?logo=linkedin&logoColor=white)](https://www.linkedin.com/in/AdarshKumar28)
...
`Java` `Python` `TypeScript` `Swift` `C#` `SQL` · `SwiftUI` `React` `Next.js` `Node.js` · `PostgreSQL` `MongoDB` `Redis` · `Gemini` `Claude` `RAG` `embeddings` · `Docker` `CI/CD` `fastlane`
